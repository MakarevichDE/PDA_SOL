## Макаревич Д.Е. БД-231м
# Тема 1. Базовые элементы Python
  -  [Самостоятельная работа 1](https://github.com/MakarevichDE/PDA_SOL/blob/main/Самостоятельная_работа_1.ipynb)
# Тема 2. Библиотека для быстрых вычислений над многомерными матрицами Numpy
  -  [Самостоятельная работа 2](https://github.com/MakarevichDE/PDA_SOL/blob/main/Самостоятельная_работа_2.ipynb)
# Тема 3. Работа с библиотекой Pandas
  -  [Самостоятельная работа 3](https://github.com/MakarevichDE/PDA_SOL/blob/main/Самостоятельная_работа_3.ipynb)
# Тема 4. Визуальный анализ данных
  -  [Самостоятельная работа 4](https://github.com/MakarevichDE/PDA_SOL/blob/main/Самостоятельная_работа_4.ipynb)
# Тема 5. Статистика в работе аналитика с библиотекой Scipy
  -  [Самостоятельная работа 5](https://github.com/MakarevichDE/PDA_SOL/blob/main/Самостоятельная_работа_5.ipynb)
# Практические работы
